...
<body>
	...
	<form:form action="/adventure/create" method="post" modelAttribute="gear" class="createItem" enctype="multpart/form-data">
		<form:input type="hidden" value="${loggedInUser.id}" path="user"/>
			...
			<button class="createBtn">Add Item</button>
		</form:form>
		<p class="registerLink"><a href="/dashboard">Return to Dashboard</a></p>
</body>
</html>
